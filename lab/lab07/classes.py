...
class Player:
    ...
    def play(self, card_index):
        ...
        """
        "*** YOUR CODE HERE ***"
        card_now = self.hand[card_index]
        self.hand.remove(card_now)
        return card_now
...
class ProfessorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        for cardll in player.deck.cards:
            cardll.attack += opponent_card.attack
            cardll.defense += opponent_card.defense

        opp_card = opponent.deck.cards.copy()
        for cardll in opp_card:
            if cardll.attack == opponent_card.attack or cardll.defense == opponent_card.defense:
                opponent.deck.cards.remove(cardll)
